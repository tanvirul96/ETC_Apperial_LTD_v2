    ...
    <div className="p-8 lg:p-12 bg-surface min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5">
          <div className="bg-white rounded-3xl border border-outline-variant/5 p-8 shadow-2xl shadow-primary/5">
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-outline-variant/5 p-8 shadow-2xl shadow-primary/5 h-[calc(100vh-280px)] overflow-y-auto">
          <div className="flex items-center gap-4 mb-8">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {admins.map((adm) => (
                <div 
                  key={adm.id}
                  className="p-5 bg-surface/40 rounded-2xl border border-outline-variant/5 flex items-center justify-between gap-6"
                >
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <div className="flex items-center justify-end gap-1 text-[9px] font-label text-on-surface-variant/75 uppercase tracking-widest">
