...
async function seed() {
    ...
    try {
        ...
        const products = [
            ...
            { name: 'Juvenile Organic Tee', price: 85, stock: 40, category: 'Kid', description: 'Soft organic cotton tee for the next generation.', sku: 'K-TEE-005', image_url: 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?auto=format&fit=crop&q=80' },
            { name: 'Geometric Pattern Scarf', price: 180, stock: 30, category: 'Women', description: 'Limited edition silk scarf from the 1998 collection.', sku: 'W-SCRF-006', image_url: 'https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?auto=format&fit=crop&q=80' }
        ];
