...
<a class="nav-link text-[#171e29] hover:text-[#885203] transition-colors" href="about-us.html">About Us</a>
...
<a class="block px-6 py-3 text-[#171e29] hover:bg-surface-container-low transition-colors" href="all-products.html">Kids</a>
<a class="block px-6 py-3 text-[#171e29] hover:bg-surface-container-low transition-colors" href="all-products.html">Mens</a>
<a class="block px-6 py-3 text-[#171e29] hover:bg-surface-container-low transition-colors" href="all-products.html">Womens</a>
<div class="h-px bg-surface-variant/20 my-1"></div>
<a class="block px-6 py-3 text-[#171e29] font-semibold hover:bg-surface-container-low transition-colors" href="all-products.html">View All Categories</a>
</div>
</div>
</div>
<a class="nav-link text-[#171e29] hover:text-[#885203] transition-colors" href="admin-dashboard.html">Management</a>
<a class="nav-link text-[#171e29] hover:text-[#885203] transition-colors" href="contact-us.html">Contact Us</a>
<a class="nav-link text-[#171e29] hover:text-[#885203] transition-colors" href="news-and-events.html">News &amp; Events</a>
</div>
</div>
...
<a href="sign-in.html" class="text-[#171e29] hover:text-[#885203] transition-colors">
